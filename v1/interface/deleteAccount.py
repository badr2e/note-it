"""Ce fichier contient la classe DeleteAccountPage qui est une interface graphique qui permet à l'administrateur de supprimer un compte utilisateur"""
...
class DeleteAccountPage(tk.Toplevel):
    def __init__(self, master, db, account): # Constructeur de la classe DeleteAccountPage
    ...
    def create_widgets(self):
        ...
        label_title = tk.Label(self, text="Supprimer un compte", font=("Arial", 24, "bold"), bg="#0053f4", fg="white")
